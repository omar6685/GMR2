...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference("Information.count") do
      post information_index_url, params: { information: { description: @information.description, description_ar: @information.description_ar, name: @information.name, name_ar: @information.name_ar, title: @information.title, title_ar: @information.title_ar, user_id: @information.user_id } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { description: @information.description, description_ar: @information.description_ar, name: @information.name, name_ar: @information.name_ar, title: @information.title, title_ar: @information.title_ar, user_id: @information.user_id } }
