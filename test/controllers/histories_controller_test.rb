...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference("History.count") do
      post histories_url, params: { history: { about_id: @history.about_id, description: @history.description, year: @history.year } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { about_id: @history.about_id, description: @history.description, year: @history.year } }
