...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference("Feature.count") do
      post features_url, params: { feature: { product_id: @feature.product_id, title: @feature.title } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { product_id: @feature.product_id, title: @feature.title } }
